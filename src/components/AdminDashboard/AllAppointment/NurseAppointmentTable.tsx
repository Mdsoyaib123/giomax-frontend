// src/components/nurseAppointment/NurseAppointmentTable.tsx
...
const NurseAppointmentTable: React.FC = () => {
  ...
  const [showRefundDialog] = useState(false);
  const [showRefundSuccess, setShowRefundSuccess] = useState(false);
  const [showStatusUpdateDialog] = useState(false);
                  ...
                  <tbody className="divide-y divide-gray-100">
                    {appointmentsData.map((appointment) => (
                      ...
                      >
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-gray-700 truncate max-w-[150px]">
