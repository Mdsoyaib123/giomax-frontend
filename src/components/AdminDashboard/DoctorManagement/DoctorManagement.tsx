...
const DoctorManagement: React.FC = () => {
  ...
  const handleRemoveConfirm = (doctor: Doctor) => {
    setConfirmSuspend(doctor);
  };
  ...
  return (
    <div className="">
                      ...
                      >
                        ...
                        <td className="px-6 py-4 text-center">
                          <div className="flex items-center justify-center gap-2">
                            ...
                            <button
                              onClick={() => handleRemoveConfirm(doctor)}
      ...
      {openProfile && (
        <div className="fixed inset-0 z-40 flex items-center justify-center bg-black/40 backdrop-blur-0.5">
          <div className="bg-white rounded-lg w-full max-w-4xl shadow-2xl p-8 relative border border-gray-300">
            <button
            ...
            <h2 className="text-2xl font-semibold text-[#1f3a44] mb-2">
              Doctor Details - {openProfile.id}
            </h2>
            <p className="text-gray-600 text-sm mb-6">
              View complete doctor profile and account information.
            </p>
      ...
      {confirmSuspend && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-0.9">
          <div className="bg-white w-full max-w-md rounded-[20px] shadow-2xl p-6 text-center relative border border-gray-200">
            ...
            <div className="flex justify-center gap-3">
              <button
                ...
                className="flex justify-center items-center gap-1.5 flex-[1_0_0] px-5 py-3.5 rounded-md bg-[#EFF4FF] border border-gray-300 text-[#2E6FF3] text-sm cursor-pointer hover:bg-gray-100 transition"
              >
                Cancel
              </button>
              ...
              <button
                ...
                className="flex justify-center items-center gap-2.5 flex-[1_0_0] px-5 py-3 rounded-md bg-[#1D4ED8] hover:bg-[#155ad1] text-white text-sm transition cursor-pointer"
              >
                Confirm
              </button>
            </div>
...
//                       {doctor.speciallity}
//                     </td>
//                     <td className="px-6 py-4 text-sky-500">{doctor.type}</td>
//                     <td className="px-6 py-4 text-gray-800">
//                       {doctor.earnings}
//                     </td>
//                     <td className="px-6 py-4">
...
//                         <button
//                           onClick={() => handleView(doctor)}
//                           className="flex items-center gap-1.5 px-3 py-1.5 bg-[#2E6FF3] hover:bg-[#1B54D3] text-white text-xs rounded-md transition"
//                         >
//                           <FaEye className="text-sm" /> View
//                         </button>
//                         <button
//                           onClick={() => handleRemove(doctor.id)}
//                           className="flex items-center gap-1.5 px-3 py-1.5 bg-[#EF4444] hover:bg-[#D92D2D] text-white text-xs rounded-md transition"
//                         >
//                           <RiDeleteBinLine className="text-sm" /> Suspend
//                         </button>
//                       </div>
...
//             <button
//               onClick={() => setOpenProfile(null)}
//               className="absolute top-4 right-4 text-gray-600 hover:text-gray-800 hover:scale-110 transition"
//             >
//               <X className="w-5 h-5" />
//             </button>
