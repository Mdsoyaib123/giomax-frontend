        ...
        <div className="w-full md:w-1/2 p-10 flex flex-col justify-center space-y-8">
          <div>
            ...
            <p className="text-start text-black">
              Sign up to get started and access your dashboard.
            </p>
          </div>
          ...
          <form className="space-y-4">
            ...
            <div className="flex flex-col mb-4">
              <label htmlFor="name" className="text-black font-sans mb-2">
                Full Name
              </label>
              <input
                type="text"
            ...
            {/* Phone */}
            <div className="flex flex-col mb-4">
              <label htmlFor="number" className="text-black font-sans mb-2">
                Phone Number
              </label>
              <input
                type="tel"
            ...
            {/* Password */}
            <div className="flex flex-col mb-4">
              <label htmlFor="password" className="text-black font-sans mb-2">
                Password
              </label>
...
// import signupphoto from "@/assets/newphoto/login1.svg";
// import logo from "@/assets/Logo/LogoMain.svg";
