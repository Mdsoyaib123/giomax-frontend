...
//   // Calculate filtered nurses
//   const filteredNurses =
//     nursesResponse?.data?.filter((nurse) => {
//       if (statusFilter === "all") return true;
//       // Since status is not in the API response, we'll use a default
//       // You should add status field to your backend response
//       return true;
//     }) || [];
...
//         }).unwrap();
//         alert(
//           `${confirmApproved.userId.fullName} has been approved successfully!`
//         );
//         setConfirmApproved(null);
//       } catch (error) {
//         console.error("Failed to update status:", error);
...
//         }).unwrap();
//         alert(
//           `${confirmSuspend.userId.fullName} has been suspended successfully!`
//         );
//         setConfirmSuspend(null);
//       } catch (error) {
//         console.error("Failed to suspend:", error);
//         alert("Failed to suspend nurse");
//       }
//     }
//   };
...
//         dispatch(removeNurse(confirmDelete._id));
//         alert(
//           `${confirmDelete.userId.fullName} has been deleted successfully!`
//         );
//         setConfirmDelete(null);
//       } catch (error) {
//         console.error("Failed to delete:", error);
...
//   // Calculate earnings (you might want to calculate this from actual data)
//   const calculateEarnings = (nurse: any) => {
//     // Calculate from paymentAndEarnings or use default
//     const earnings =
//       nurse.paymentAndEarnings?.totalEarnings?.totalThisMonth || 0;
//     return `$${earnings.toFixed(2)}`;
//   };
...
//     return (
//       <div className="flex justify-center items-center h-64">
//         <div className="text-lg">Loading nurses...</div>
//       </div>
//     );
//   }
...
//                           <span
//                             className={`px-3 py-1 text-xs font-medium rounded-full ${getStatusColor(
//                               "active" // Default status - you should update this based on your data
//                             )}`}
//                           >
...
//                               className="flex cursor-pointer items-center gap-1.5 px-3 py-1.5 bg-[#EFF4FF] text-[#2E6FF3] border border-[#ECEFF1] hover:bg-gray-100 text-xs rounded-md transition"
//                             >
//                               <TiDeleteOutline className="text-sm" /> Reject
//                             </button>
//                             <button
//                               onClick={() => handleDeleteConfirm(nurse)}
//                               className="flex cursor-pointer items-center gap-1.5 px-3 py-1.5 bg-red-600 hover:bg-red-700 text-white text-xs rounded-md transition"
