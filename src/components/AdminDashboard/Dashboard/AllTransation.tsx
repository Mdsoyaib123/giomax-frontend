              ...
              <table className="min-w-[800px] w-full text-sm">
                <thead className="bg-gray-100 border-b border-gray-200">
                  <tr>
                    ...
                    <th className="px-6 py-4 text-left">Receiver ID</th>
                ...
                <tbody className="divide-y divide-gray-200">
                  {paginatedData.map((transaction: any) => (
                    <tr key={transaction._id} className="hover:bg-gray-50">
                      <td className="px-6 py-4">{transaction._id.slice(-8)}</td>

                      <td className="px-6 py-4">
                        {transaction.receiverId.slice(-8)}
                      </td>
      ...
      {totalItems > 0 && (
        <div className="mt-6 flex items-center justify-between">
          ...
          <div className="flex gap-2">
            ...
            <button className="px-4 py-1.5 border rounded-lg bg-blue-600 text-white">
              {currentPage}
            </button>
