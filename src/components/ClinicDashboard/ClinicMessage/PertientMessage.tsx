...
const PertientMessage: React.FC = () => {
  ...
  const messages: Message[] = [
    {
      id: 1,
      text: "Hello, there. I believe I have the examination as re-experiencing into symptoms-what do I do?",
      time: "10:12 AM",
      sender: "other",
      isRead: true,
    },
    {
      id: 2,
      text: "Lorem ipsum dolor sit amet consectetur. Justo ac non magna massa.",
      time: "10:14 AM",
      sender: "user",
      isRead: true,
    },
    ...
    },
    {
      ...
      sender: "other",
      isRead: true,
      attachment: { name: "Prescription.pdf", size: "2.5 MB" },
    },
  ];
      ...
      <div className="w-full mx-auto ">
        ...
        <div className="flex bg-white shadow-2xl rounded-xl overflow-hidden">
          ...
          <div
            ...
            } md:block w-full md:w-80 bg-white border-r border-gray-200 flex flex-col absolute md:relative z-10 h-full`}
          >
            {/* Sidebar Header */}
