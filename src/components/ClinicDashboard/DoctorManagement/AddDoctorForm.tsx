...
//     status: string;
//     workingHour: string;
//     availabilitySchedule: string; // This corresponds to 'Working Days' in your previous example
// }

// const serviceTypeOptions = ["Select Service Type", "Online Only", "Clinic Visit Only", "Both (Online & Clinic Visit)"];
...
//     const renderInput = (label: string, name: keyof DoctorData, type: string = "text", placeholder: string, required: boolean = true, icon?: React.ReactNode) => (
//         <div>
...
//     const renderSelect = (label: string, name: keyof DoctorData, options: string[], required: boolean = true) => (
//         <div>
//             <label className="block text-sm font-semibold text-gray-700 mb-1">
//                 {label} {required && <span className="text-red-500">*</span>}
//             </label>
...
//                 >
//                     {options.map(option => (
//                         <option key={option} value={option} disabled={option.includes("Select")}>{option}</option>
//                     ))}
//                 </select>
...
//                         {/* Row 1: Doctor Name & Email Address */}
//                         <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
//                             {renderInput("Doctor Name", "name", "text", "Dr. David Giorgadze")}
//                             {renderInput("Email Address", "email", "email", "david.g@gmail.com")}
//                         </div>

//                         {/* Row 2: Phone Number & License Number */}
//                         <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
//                             {renderInput("Phone Number", "phone", "text", "+995 595 123456")}
//                             {renderInput("License Number", "licenseNumber", "text", "MED-001-2024")}
//                         </div>
...
//                         {/* Row 4: Upload Certificate & Working Hour */}
//                         <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
//                             <div>
//                                 <label className="block text-sm font-semibold text-gray-700 mb-1">
...
//                                 <button
//                                     type="button"
//                                     className="flex items-center justify-center w-full px-4 py-3 text-sm font-semibold text-blue-600 bg-white border-2 border-dashed border-blue-300 rounded-lg hover:bg-blue-50 transition-colors"
//                                     onClick={() => console.log("Upload Certificate Clicked")}
//                                 >
...
//                             </div>
//                             {renderInput("Working Hour", "workingHour", "text", "Select Doctor's Working Hour", true, <Clock className="w-4 h-4 text-gray-400" />)}
//                         </div>

//                         {/* Row 5: Availability Schedule */}
//                         <div>
//                             {renderInput("Availability Schedule", "availabilitySchedule", "text", "Monday, Tuesday, Wednesday, Friday")}
            ...
            <div className="bg-white rounded-xl max-w-4xl w-[1100px] relative shadow-2xl border border-gray-200 transform transition-all max-h-[95vh] overflow-hidden flex flex-col">
                ...
                <form onSubmit={handleSubmit} className="flex-grow overflow-y-auto">
                    <div className="p-6 space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                >
                                    <UploadCloud className="w-5 h-5 mr-2" />
                                    {formData.certificateFile ? formData.certificateFile.name : "Upload your doctor certificate"}
                                </label>
                    ...
                    <div className="p-4 sm:p-6 border-t border-gray-100 flex flex-col sm:flex-row justify-end gap-3 flex-shrink-0 w-full bg-white">
                        ...
                        <button
                            type="submit"
                            className="px-6 py-2.5 text-sm font-semibold w-[493px] h-[56px] rounded-[6px] text-[#FFFFFF] bg-blue-600 hover:bg-blue-700 shadow-md shadow-blue-500/30 flex items-center justify-center gap-2 transition-colors"
                        >
