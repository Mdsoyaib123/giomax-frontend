...
const TeamManagement: React.FC = () => {
  const [teamMembers, setTeamMembers] = useState<TeamMember[]>([
    { id: '1', name: 'Admin User', email: 'admin@medconnect.com', role: 'Admin' },
    { id: '2', name: 'Sarah Manager', email: 'sarah@medconnect.com', role: 'Admin' },
    { id: '3', name: 'John Moderator', email: 'john@medconnect.com', role: 'Moderator' }
  ]);
  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
      ...
      <p className="text-sm text-gray-600 mb-6">Manage team members who can access this panel</p>
