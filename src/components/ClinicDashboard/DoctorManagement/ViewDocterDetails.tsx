...
const mockAppointments: Appointment[] = [
    { dateAndTime: '25/10/2025 - 10:20 AM', patientName: 'Dr. Mike Shinoda', serviceType: 'Clinic Visit', status: 'Completed' },
    { dateAndTime: '25/10/2025 - 10:20 AM', patientName: 'Dr. Emily Rodriguez', serviceType: 'Clinic Visit', status: 'Completed' },
    { dateAndTime: '25/10/2025 - 10:20 AM', patientName: 'Dr. Lisa Anderson', serviceType: 'Clinic Visit', status: 'Completed' },
    { dateAndTime: '25/10/2025 - 10:20 AM', patientName: 'Dr. Michael Chan', serviceType: 'Both', status: 'Completed' },
    { dateAndTime: '25/10/2025 - 10:20 AM', patientName: 'Dr. Sarah Johnson', serviceType: 'Clinic Visit', status: 'Upcoming' },
];
            ...
            <div className="bg-white w-[1100px] h-[1446px] rounded-[8px]   max-w-4xl relative shadow-2xl border border-gray-200 transform transition-all max-h-[95vh] overflow-hidden flex flex-col">
                ...
                <div className="flex items-start justify-between p-6 border-b border-gray-100 flex-shrink-0">
                    <div>
                        ...
                        <p className="text-sm text-gray-500 mt-1">Complete information about this Details</p>
                    </div>
                ...
                <div className="flex-grow overflow-y-auto p-6 space-y-6">
                    ...
                    <div>
                        <label className="block text-base font-bold text-gray-900 mb-2">Availability</label>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            {/* Availability Days */}
                            <div className="flex flex-wrap gap-2 py-3">
                                {doctor.availability.map(day => (
                                    <span key={day} className="px-3 py-1 text-sm font-medium text-blue-700 bg-blue-100 rounded-md">
                                        {day}
                                    </span>
                                ))}
                            </div>
...
// Main App component for self-containment and state management
const App = () => {
    // State to manage the visibility of the modal. Set to true by default to show it immediately.
    const [isModalOpen, setIsModalOpen] = useState(true);

    // Function to close the modal (hide the page content)
    const handleClose = () => {
        // This will remove the modal/page from the screen
        ...
        <div className="bg-gray-100 p-8 h-screen w-full flex items-center justify-center font-inter">
            ...
            {/* {!isModalOpen && (
                <div className="text-xl font-semibold text-gray-700 p-8 bg-white rounded-xl shadow-lg">
                    The Doctor Profile has been closed. (Page is off.)
                </div>
            )} */}
