...
const DashboardCard = () => {
  ...
  // Mock previous month data (replace with API later if needed)
  ...
  const statsData = [
    {
      ...
      amount: overviewData?.data.totalPatients ?? 0,
      change: calculateChange(
        overviewData?.data.totalPatients ?? 0,
        previousMonthData.totalPatients
      ),
      unit: "vs last month",
      icon: Patients,
    },
    {
      title: "Total Doctors",
      amount: overviewData?.data.totalDoctors ?? 0,
      change: calculateChange(
        overviewData?.data.totalDoctors ?? 0,
        previousMonthData.totalDoctors
      ),
      unit: "vs last month",
      icon: Doctors,
    },
    {
      title: "Total Clinics",
      amount: overviewData?.data.totalClinics ?? 0,
      change: calculateChange(
        overviewData?.data.totalClinics ?? 0,
        previousMonthData.totalClinics
      ),
      unit: "vs last month",
      icon: Clinics,
    },
    {
      title: "Total Appoint",
      amount: overviewData?.data.totalAppointments ?? 0,
      change: calculateChange(
        overviewData?.data.totalAppointments ?? 0,
    ...
    //   amount: `$${overviewData?.data.totalEarnings ?? 0}`,
    //   change: calculateChange(
    //     overviewData?.data.totalEarnings ?? 0,
    //     previousMonthData.totalEarnings
    //   ),
    //   unit: "vs last month",
    //   icon: Earnings,
    // },
