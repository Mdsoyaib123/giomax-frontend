...
//       <div className="w-[1599px] h-[430px]">
     
//         <div className="bg-white rounded-xl p-4 sm:p-6 lg:p-8 mt-6 shadow-lg  "> 

//           {/* Header - Remains responsive due to flex-col/sm:flex-row */}
...
//             {/* Button to open Add Payment Method Modal (Component 1) - `whitespace-nowrap` prevents wrapping on small screens */}
//             <button
...
//           {/* Payment Methods List - Uses responsive grid: 1 column on mobile, 2 columns on small screens and up */}
...
//           {/* Bottom Buttons - Uses responsive flex: column reverse on mobile, row on small screens and up. w-full ensures buttons stretch on mobile.*/}
...
//           onSubmit={handleAddPaymentMethod} // Links to Component 2
//         />
//       )}
...
//         <PaymentSuccessModal
//           onClose={handleCloseAll}
//           onBack={handleBackToForm} // Links back to Component 1
//         />
//       )}
//     </div>
//   );
