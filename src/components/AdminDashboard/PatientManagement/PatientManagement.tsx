...
//     gender: patient.gender,
//     bloodGroup: patient.bloodGroup,
//     totalBookings: "0", // Add logic if you have booking data
//     lastAppointment: new Date().toLocaleDateString(), // Add logic if you have appointment data
//     createdAt: new Date(patient.createdAt).toLocaleDateString(),
//   };
// };
...
//               value={selectedPatient.name}
//               readOnly
//               className="w-full px-3 py-3 border border-[#ECEFF1] rounded-lg bg-[#F8F9FA] text-gray-900 focus:outline-none"
//             />
//           </div>
...
//               readOnly
//               className="w-full px-3 py-3 border border-[#ECEFF1] rounded-xl bg-[#F8F9FA] text-gray-900 focus:outline-none"
//             />
//           </div>
...
//   const { data: singlePatient } = useGetSinglePatientQuery(
//     selectedPatient?.id!,
//     {
//       skip: !selectedPatient?.id,
//     }
//   );
//   console.log("Single Patient Data:", singlePatient);
...
//   // Find full patient data for modal
//   const fullPatientData = useMemo(() => {
//     if (!selectedPatient || !patientsResponse?.data) return undefined;
//     return patientsResponse.data.find((p) => p._id === selectedPatient.id);
//   }, [selectedPatient, patientsResponse]);
...
// const PatientManagement: React.FC<Props> = () => {
//   const dispatch = useAppDispatch();
//   const navigate = useNavigate();
...
//   const [tableData, setTableData] = useState<PatientTableData[]>([]);
//   const [filteredData, setFilteredData] = useState<PatientTableData[]>([]);
//   const [paginatedData, setPaginatedData] = useState<PatientTableData[]>([]);

//   // Format and set patient data
//   useEffect(() => {
//     if (patientsResponse?.data) {
//       const formattedData = patientsResponse.data.map(formatPatientForTable);
...
//       const filtered = filterPatients(tableData, searchTerm);
//       setFilteredData(filtered);
//       dispatch(setCurrentPage(1)); // Reset to first page when filtering
//     }
//   }, [tableData, searchTerm, dispatch]);
...
//   if (isLoading) {
//     return (
//       <div className="flex justify-center items-center h-64">error found</div>
//     );
//   }
...
//             {/* Medical History Section */}
//             {patientsResponse?.data && selectedPatient && (
//               <div className="mt-6">
//                 <h3 className="text-xl font-semibold text-gray-800 mb-4">
//                   Medical History
//                 </h3>
...
//                 {(() => {
//                   const fullPatient = patientsResponse.data.find(
//                     (p) => p._id === selectedPatient.id
//                   );
...
//                         </h4>
//                         <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
//                           {fullPatient.medicalHistory.conditions.map(
//                             (condition) => (
//                               <div
//                                 key={condition._id}
...
//                         </h4>
//                         <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
//                           {fullPatient.medicalHistory.Medications.map((med) => (
//                             <div
//                               key={med._id}
...
//                         </h4>
//                         <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
//                           {fullPatient.medicalHistory.Allergies.map(
//                             (allergy) => (
//                               <div
//                                 key={allergy._id}
...
//                                 </p>
//                                 <p className="text-sm text-gray-600">
//                                   Severity: {allergy.severity} | Reaction:{" "}
//                                   {allergy.reaction}
//                                 </p>
//                               </div>
//                             )
