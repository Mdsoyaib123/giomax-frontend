...
const TransactionHistory: React.FC = () => {
    ...
    // Total Page-er hishab (9 transactions / 5 items per page = 2 pages)
    ...
    return (
        ...
        //         </div>
        //         {/* Main Table Card */}
        //         <div className="rounded-xl border border-gray-200 bg-white shadow-sm p-6 border-1px">

        //             <div className="flex items-center justify-between mb-5 w-full">
        //                 <h2 className="text-xl font-semibold text-[#343A40]">Transaction History</h2>

        //                 {/* "All Status" dropdown */}
        //                 <div className="relative ">
        //                     <select
        //                         className="appearance-none block w-full bg-white border border-gray-300 rounded-md py-2 pl-3 pr-10 text-sm leading-5 focus:outline-none focus:ring-blue-500 focus:border-blue-500 cursor-pointer"
        ...
        //                         <tr>
        //                             <th className="px-6 py-4 text-left font-medium text-gray-700 whitespace-nowrap">Transaction ID</th>
        //                             <th className="px-6 py-4 text-left font-medium text-gray-700 whitespace-nowrap">Receiver</th>
        //                             <th className="px-6 py-4 text-left font-medium text-gray-700 whitespace-nowrap">Service</th>
        //                             <th className="px-6 py-4 text-left font-medium text-gray-700 whitespace-nowrap">Amount</th>
        //                             <th className="px-6 py-4 text-left font-medium text-gray-700 whitespace-nowrap">Date</th>
        //                             <th className="px-6 py-4 text-left font-medium text-gray-700 whitespace-nowrap">Status</th>
        //                         </tr>
        //                     </thead>

        //                     <tbody className="divide-y divide-gray-200">
        //                         {currentTransactions.map((u) => (
        //                             <tr key={u.transactionId} className="hover:bg-gray-50">
        //                                 <td className="px-6 py-4 font-medium text-gray-900 whitespace-nowrap">{u.transactionId}</td>
        //                                 <td className="px-6 py-4 text-gray-700 whitespace-nowrap">{u.receiver}</td>
        //                                 <td className="px-6 py-4 text-gray-700 whitespace-nowrap">{u.service}</td>
        //                                 <td className="px-6 py-4 font-semibold text-blue-600 whitespace-nowrap">${u.amount.toFixed(2)}</td>
        //                                 <td className="px-6 py-4 text-gray-500 whitespace-nowrap">{u.date}</td>
        ...
        //                         className={`px-3 py-1.5 border border-gray-300 rounded-lg text-sm transition ${currentPage === 1 ? "opacity-50 cursor-not-allowed text-gray-400" : "hover:bg-gray-100 bg-white text-blue-600"
        //                             }`}
        //                     >
        //                         Prev
        //                     </button>
        ...
        //                             className={`min-w-[32px] px-3 py-1.5 border rounded-lg text-sm transition ${currentPage === page
        ...
        //                         className={`px-3 py-1.5 border border-gray-300 rounded-lg text-sm transition ${currentPage === totalPages ? "opacity-50 cursor-not-allowed text-gray-400" : "hover:bg-gray-100 bg-white text-blue-600"
        //                             }`}
        //                     >
        //                         Next
        //                     </button>
        ...
        <div className="mt-4 sm:mt-6 flex flex-col sm:flex-row items-center justify-between gap-4 sm:gap-0">
          ...
          <div className="flex items-center gap-1 overflow-x-auto w-full sm:w-auto">
            ...
            <button
              onClick={() => handlePageChange(currentPage - 1)}
              disabled={currentPage === 1}
              className={`px-2 sm:px-3 py-1.5 border border-gray-300 rounded-lg text-xs sm:text-sm transition whitespace-nowrap ${
                currentPage === 1 
            ...
            {getPageNumbers().map((page) => (
              <button
                key={page}
                onClick={() => handlePageChange(page)}
                className={`min-w-[32px] px-2 sm:px-3 py-1.5 border rounded-lg text-xs sm:text-sm transition ${
                  currentPage === page
                    ? "bg-blue-600 text-white border-blue-600"
                    : "bg-white text-gray-700 border-gray-300 hover:bg-gray-100"
                }`}
